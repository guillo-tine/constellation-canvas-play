...
export default function Home() {
  ...
  if (loading) return <StatusMessage variant="loading" message="Loading puzzles…" />;
  if (error || levels.length === 0) {
    return <StatusMessage variant="error" message="Could not load puzzles." />;
  }
  ...
  return (
    <PageShell>
      <div className="max-w-xl mx-auto text-center pt-16 sm:pt-24">
        <motion.h1
          {...fadeUp}
        ...
        >
          Connect the dots to reveal hidden constellations. A daily puzzle of
          precision, memory, and pattern recognition.
        </motion.p>
